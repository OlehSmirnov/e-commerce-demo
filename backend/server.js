...
app.use(cors({
  origin: ["http://localhost:3000", "https://e-commerce-demo-fivi.onrender.com"], // твої фронтенди
  methods: ["GET", "POST", "OPTIONS"],  // важливо включити OPTIONS
  allowedHeaders: ["Content-Type", "Authorization"], // потрібні заголовки
  credentials: true
}));
